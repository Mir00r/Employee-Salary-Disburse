package com.mir00r.salarydisburse.interceptors;
...
import com.mir00r.salarydisburse.domains.activities.services.ActivityService;
...
public class ActivityInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        activity.addTag(Activity.Tag.SYNC);
